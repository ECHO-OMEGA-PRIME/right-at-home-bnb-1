...
# RAH Midland's real, controlled Firebase project is echo-prime-ai; the retired
# project is inaccessible to us (see apps/web/src/lib/firebase-client-config.ts, commit
