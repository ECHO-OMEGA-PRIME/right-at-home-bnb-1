...
"""
    ...
    def _get_fallback_response(self, query: str) -> str:
        ...
        fallbacks = {
            QueryIntent.WIFI_ACCESS: "Wi-Fi details are private. Open the authenticated active-stay dashboard or contact Steven for help.",
    ...
    def get_property_info(self, property_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "property": {
                ...
                "wifi_available": bool(prop.wifi_network),
