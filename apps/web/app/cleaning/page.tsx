...
const mockCleaners: CleanerProfile[] = [
  {
    ...
    name: 'Maria Santos',
    phone: '(432) 555-0101',
    email: 'maria@rightathome.com',
    rating: 4.9,
    totalJobs: 487,
    completedJobs: 485,
    avgTimeMinutes: 95,
    avgScore: 97,
    specialties: ['Deep Clean', 'Pet-Friendly'],
    status: 'on_job',
    currentLocation: { lat: 31.9973, lng: -102.0779 },
    currentJobId: 'clean-003',
    badges: [
      { id: 'b1', name: 'Speed Demon', icon: '⚡', earnedAt: new Date(), description: '50+ jobs under time' },
      { id: 'b2', name: 'Perfect 10', icon: '🌟', earnedAt: new Date(), description: '10 perfect scores in a row' },
      { id: 'b3', name: 'Early Bird', icon: '🐦', earnedAt: new Date(), description: 'Always arrives early' }
    ],
    streak: 23,
    earnings: { week: 1250, month: 4800, year: 58000 }
  },
  {
    id: 'cleaner-2',
    name: 'Rosa Garcia',
    phone: '(432) 555-0102',
    email: 'rosa@rightathome.com',
    rating: 4.8,
    totalJobs: 312,
    completedJobs: 310,
    avgTimeMinutes: 105,
    avgScore: 95,
    specialties: ['Turnover', 'Laundry'],
    status: 'available',
    currentLocation: { lat: 32.0100, lng: -102.0900 },
    badges: [
      { id: 'b4', name: 'Detail Master', icon: '🔍', earnedAt: new Date(), description: 'Exceptional attention to detail' }
    ],
    streak: 15,
    earnings: { week: 980, month: 3900, year: 42000 }
  },
  {
    id: 'cleaner-3',
    name: 'Ana Martinez',
    phone: '(432) 555-0103',
    email: 'ana@rightathome.com',
    rating: 4.7,
    totalJobs: 198,
    completedJobs: 195,
    avgTimeMinutes: 110,
    avgScore: 93,
    specialties: ['Deep Clean'],
    status: 'en_route',
    currentLocation: { lat: 31.9850, lng: -102.0650 },
    badges: [],
    streak: 8,
    earnings: { week: 720, month: 2800, year: 31000 }
  },
  {
    id: 'cleaner-4',
    name: 'Carmen Lopez',
    phone: '(432) 555-0104',
    email: 'carmen@rightathome.com',
    rating: 4.6,
    totalJobs: 156,
    completedJobs: 154,
    avgTimeMinutes: 115,
    avgScore: 91,
    specialties: ['Touch Up', 'Inspection'],
    status: 'offline',
    badges: [],
    streak: 0,
    earnings: { week: 0, month: 2100, year: 24000 }
  }
];

const mockVerificationPhotos: VerificationPhoto[] = [
  { id: 'p1', url: '/photos/kitchen-clean.jpg', room: 'Kitchen', timestamp: new Date(), aiScore: 98, aiNotes: ['Counters spotless', 'Appliances cleaned'], verified: true },
  { id: 'p2', url: '/photos/bathroom-clean.jpg', room: 'Master Bath', timestamp: new Date(), aiScore: 95, aiNotes: ['Fixtures gleaming', 'Towels arranged'], verified: true },
  { id: 'p3', url: '/photos/bedroom-clean.jpg', room: 'Master Bedroom', timestamp: new Date(), aiScore: 97, aiNotes: ['Bed made perfectly', 'Surfaces dusted'], verified: true },
  { id: 'p4', url: '/photos/living-clean.jpg', room: 'Living Room', timestamp: new Date(), aiScore: 94, aiNotes: ['Furniture arranged', 'Floors vacuumed'], verified: false },
  { id: 'p5', url: '/photos/entry-clean.jpg', room: 'Entry', timestamp: new Date(), aiScore: 96, aiNotes: ['Welcome mat clean', 'Door handle sanitized'], verified: true },
  { id: 'p6', url: '/photos/patio-clean.jpg', room: 'Patio', timestamp: new Date(), aiScore: 92, aiNotes: ['Furniture wiped', 'Debris cleared'], verified: false },
];

const mockAIScore: AIScoreBreakdown = {
  overall: 96,
  categories: [
    { name: 'Cleanliness', score: 48, maxScore: 50, notes: ['All surfaces clean', 'No dust detected'] },
    { name: 'Organization', score: 19, maxScore: 20, notes: ['Items properly arranged', 'Closets organized'] },
    { name: 'Supplies', score: 14, maxScore: 15, notes: ['All amenities stocked', 'Toiletries full'] },
    { name: 'Presentation', score: 15, maxScore: 15, notes: ['Beds perfectly made', 'Towel art complete'] }
  ],
  recommendations: [
    'Consider extra attention to window tracks',
    'Guest book could be more prominently displayed'
  ],
  comparisonToAvg: 4.2
};

// Sample cleaning jobs using real property IDs
const mockJobs: ExtendedCleaningJob[] = [
  {
    id: 'clean-001',
    propertyId: 'castleford-5001',
    propertyName: propertyNames['castleford-5001']?.name || 'Castleford Retreat',
    cleanerId: 'cleaner-2',
    cleanerName: 'Rosa Garcia',
    ...
    overallNotes: '',
    urgencyLevel: 'high',
    guestCheckIn: new Date(Date.now() + 4 * 3600000),
    estimatedArrival: new Date(Date.now() + 1800000),
    specialInstructions: 'Guest requested extra towels',
    suppliesNeeded: ['Extra towels', 'Wine glasses']
  },
  {
    id: 'clean-002',
    propertyId: 'shandon-4600',
    propertyName: propertyNames['shandon-4600']?.name || 'Shandon Suite',
    cleanerId: 'cleaner-3',
    cleanerName: 'Ana Martinez',
    ...
    overallNotes: '',
    urgencyLevel: 'normal',
    guestCheckIn: new Date(Date.now() + 28 * 3600000)
  },
  {
    id: 'clean-003',
    propertyId: 'garfield-2702',
    propertyName: propertyNames['garfield-2702']?.name || 'Garfield House',
    cleanerId: 'cleaner-1',
    ...
    jobType: 'turnover',
    status: 'in_progress',
    checklist: Array(50).fill(null).map((_, i) => ({
      itemId: `item-${i}`,
      completed: i < 35
    })),
    issues: [{
      ...
      severity: 'medium',
      title: 'Leaky faucet',
      description: 'Master bathroom sink dripping',
      location: 'Master bath',
      photoUrls: [],
      reportedAt: new Date(),
      status: 'reported'
    }],
    verificationPhotos: mockVerificationPhotos.slice(0, 4),
    overallNotes: 'In progress - 70% complete',
    urgencyLevel: 'high',
    guestCheckIn: new Date(Date.now() + 2 * 3600000),
    actualArrival: new Date(Date.now() - 3600000),
    aiScore: { ...mockAIScore, overall: 94 },
    cleaner: mockCleaners[0]
  },
  {
    id: 'clean-004',
    propertyId: 'haynes-2802',
    propertyName: propertyNames['haynes-2802']?.name || 'Haynes Haven',
    cleanerId: 'cleaner-1',
    cleanerName: 'Maria Santos',
    scheduledAt: new Date(Date.now() - 86400000),
    ...
    issues: [],
    verificationPhotos: mockVerificationPhotos,
    overallNotes: 'Excellent job! Guest was thrilled.',
    rating: 5,
    timeSpentMinutes: 95,
    urgencyLevel: 'normal',
    aiScore: mockAIScore,
  ...
  {
    id: 'clean-005',
    propertyId: 'louisiana-3502',
    propertyName: propertyNames['louisiana-3502']?.name || 'Louisiana Lodge',
    cleanerId: 'cleaner-2',
    cleanerName: 'Rosa Garcia',
    ...
    jobType: 'deep_clean',
    status: 'completed',
    checklist: Array(75).fill(null).map((_, i) => ({
      itemId: `item-${i}`,
      completed: true
    })),
    issues: [],
    verificationPhotos: mockVerificationPhotos,
    overallNotes: 'Deep clean completed. All areas spotless.',
    rating: 5,
    timeSpentMinutes: 180,
    urgencyLevel: 'low',
    aiScore: { ...mockAIScore, overall: 98 },
