...
const mockBills: Bill[] = [
  {
    id: '1',
    vendor: 'Midland Electric Co.',
    vendorContact: 'billing@midlandelectric.com',
    category: 'utilities',
    description: 'Electric service - 22 properties, March 2026',
    amount: 486200,
    dueDate: '2026-03-20',
    status: 'due',
    invoiceRef: 'MEC-2026-3841',
    recurring: true,
    properties: 'All 22 Units',
  },
  {
    id: '2',
    vendor: 'West Texas Gas',
    vendorContact: 'accounts@wtgas.com',
    category: 'utilities',
    description: 'Natural gas service - 22 properties, March',
    amount: 198400,
    dueDate: '2026-03-22',
    status: 'due',
    invoiceRef: 'WTG-87423',
    recurring: true,
    properties: 'All 22 Units',
  },
  {
    id: '3',
    vendor: 'Midland Water Authority',
    vendorContact: 'billing@midlandwater.gov',
    category: 'utilities',
    description: 'Water & sewer - 22 properties, March',
    amount: 154000,
    dueDate: '2026-03-25',
    status: 'scheduled',
    invoiceRef: 'MWA-2026-0315',
    recurring: true,
    properties: 'All 22 Units',
  },
  {
    ...
    vendorContact: 'invoices@abccleaning.com',
    category: 'cleaning',
    description: 'Turnover cleans x12, deep cleans x3',
    amount: 378000,
    dueDate: '2026-03-18',
    status: 'due',
    invoiceRef: 'ABC-6742',
    recurring: false,
    properties: 'Units 1,3,5,7,9,12,14,15,17,18,20,21',
  },
  {
    id: '5',
    vendor: 'Permian Basin Maintenance',
    vendorContact: 'mike@pbmaint.com',
    category: 'maintenance',
    description: 'HVAC tune-up (10 units) + plumbing repair (Unit 7)',
    amount: 345000,
    dueDate: '2026-03-15',
    status: 'overdue',
    invoiceRef: 'PBM-2026-0287',
    recurring: false,
    properties: 'Units 1-10, Unit 7',
  },
  {
    id: '6',
    vendor: 'State Farm Insurance',
    vendorContact: 'agent.jones@statefarm.com',
    category: 'insurance',
    description: 'Property insurance - Q2 installment, 22 properties',
    amount: 345600,
    dueDate: '2026-04-01',
    status: 'scheduled',
    invoiceRef: 'SF-POL-8834521',
    recurring: true,
    properties: 'All 22 Units',
  },
  {
    ...
    vendorContact: 'mortgage@fnb-midland.com',
    category: 'mortgage',
    description: 'Monthly mortgage payments - 18 financed properties',
    amount: 2145000,
    dueDate: '2026-03-01',
    status: 'paid',
    invoiceRef: 'FNB-MTG-042',
    recurring: true,
    properties: '18 Financed Units',
  },
  {
    id: '8',
    vendor: 'Midland County Tax Office',
    vendorContact: 'tax@midlandcounty.gov',
    category: 'property_tax',
    description: 'Property tax - Q1 installment, 22 parcels',
    amount: 1876500,
    dueDate: '2026-03-31',
    status: 'due',
    invoiceRef: 'MC-TAX-2026-Q1',
    recurring: true,
    properties: 'All 22 Parcels',
  },
  {
    id: '9',
    vendor: 'Home Depot Pro',
    vendorContact: 'prosales@homedepot.com',
    category: 'supplies',
    description: 'Bulk supplies: linens, toiletries, cleaning products',
    amount: 87500,
    dueDate: '2026-03-10',
    status: 'overdue',
    invoiceRef: 'HDP-INV-334182',
    recurring: false,
    properties: 'Inventory',
  },
  {
    id: '10',
    vendor: 'Basin Lawn & Landscape',
    vendorContact: 'scheduling@basinlawn.com',
    category: 'landscaping',
    description: 'Monthly lawn care - 22 properties, March',
    amount: 132000,
    dueDate: '2026-03-28',
    status: 'scheduled',
    invoiceRef: 'BLL-2026-03',
    recurring: true,
    properties: 'All 22 Units',
  },
  {
    id: '11',
    vendor: 'Permian Pest Solutions',
    vendorContact: 'service@permianpest.com',
    category: 'pest_control',
    description: 'Quarterly pest treatment - 22 properties',
    amount: 66000,
    dueDate: '2026-03-15',
    status: 'overdue',
    invoiceRef: 'PPS-Q1-2026',
    recurring: true,
    properties: 'All 22 Units',
  },
  {
    id: '12',
    vendor: 'Guesty',
    vendorContact: 'billing@guesty.com',
    category: 'software',
    description: 'Property management platform - March subscription',
    amount: 44900,
    dueDate: '2026-03-01',
    status: 'paid',
    invoiceRef: 'GUESTY-2026-03',
    recurring: true,
    properties: 'N/A',
  },
  {
    id: '13',
    vendor: 'Thompson & Associates',
    vendorContact: 'billing@thompson-law.com',
    category: 'legal',
    description: 'Legal consultation - LLC compliance review',
    amount: 125000,
    dueDate: '2026-03-20',
    status: 'due',
    invoiceRef: 'TA-2026-0089',
    recurring: false,
    properties: 'N/A',
  },
  {
    id: '14',
    vendor: 'Suddenlink Communications',
    vendorContact: 'business@suddenlink.com',
    category: 'utilities',
    description: 'Internet service - 22 properties, March',
    amount: 154000,
    dueDate: '2026-03-05',
    status: 'paid',
    invoiceRef: 'SLC-BUS-2026-03',
    recurring: true,
    properties: 'All 22 Units',
  },
];
